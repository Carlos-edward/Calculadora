...
begin
    case AnsiIndexStr((Sender as TLabel).GetNamePath,['zeroButton','oneButton','twoButton','threeButton','fourButton','fiveButton','sixButton','sevenButton','eightButton','nineButton','commaButton','backspaceButton','raizButton','porButton']) of
         // Numeros
         ...
         11:screenText.Caption := copy(screenText.Caption,0,length(screenText.Caption)-1);
         12:screenText.Caption := floatToStr(Sqrt(StrToInt(screenText.Caption)));
         13:screenText.Caption := floatToStr(StrToInt(screenText.Caption)/100);
    end;
end;
